...
#### Your answer: [Using Math.random(), which returns a number from zero to one. If for example I want an integer between 1 and 100, I would use it like this: int random = (int)(Math.random()*100);]
